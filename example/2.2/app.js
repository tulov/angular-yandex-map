...
angular.module('myApp', ['ngRoute','ui.bootstrap','yaMap'], function($routeProvider, $locationProvider) {
    $routeProvider.when('/2.2/', {
            templateUrl: '2.2/partials/map-add.html',
            controller: MapAddCtrl
        })
        .when('/2.2/map/change', {
            templateUrl: '2.2/partials/map-change.html',
            controller: MapChangeCtrl
        })
        .when('/2.2/map/create', {
            templateUrl: '2.2/partials/create.html',
            controller: EmptyCtrl
        })
        .when('/2.2/map/own-map',{
            templateUrl:'2.2/partials/own-map.html',
            controller:OwnMapCtrl
        })
        .when('/2.2/balloon-and-hint',{
            templateUrl:'2.2/partials/hint-and-balloon.html',
            controller:HintAndBalloonCtrl
        })
        .when('/2.2/balloon-and-hint/dynamic-balloon',{
            templateUrl:'2.2/partials/dynamic-balloon.html',
            controller:DynamicBalloonCtrl
        })
        .when('/2.2/balloon-and-hint/balloon-panel',{
            templateUrl:'2.2/partials/balloon-panel.html',
            controller:BalloonPanelCtrl
        })
        .when('/2.2/active-area',{
            templateUrl:'2.2/partials/active-area-layout.html',
            controller:EmptyCtrl
        })
        .when('/2.2/geoobjects/points',{
            templateUrl:'2.2/partials/points.html',
            controller:PointsCtrl
        })
        .when('/2.2/geoobjects/linestring',{
            templateUrl:'2.2/partials/linestring.html',
            controller:LineStringCtrl
        })
        .when('/2.2/geoobjects/rectangle',{
            templateUrl:'2.2/partials/rectangle.html',
            controller:RectangleCtrl
        })
        .when('/2.2/geoobjects/polygon',{
            templateUrl:'2.2/partials/polygon.html',
            controller:PolygonCtrl
        })
        .when('/2.2/geoobjects/circle',{
            templateUrl:'2.2/partials/circle.html',
            controller:CircleCtrl
        })
        .when('/2.2/geoobjects/add-to-collection',{
            templateUrl:'2.2/partials/add-to-collection.html',
            controller:AddObjToCollection
        })
        .when('/2.2/geoobjects/linestring-edit',{
            templateUrl:'2.2/partials/linestring-edit.html',
            controller:LineStringEditCtrl
        })
        .when('/2.2/geoobjects/polygon-draw',{
            templateUrl:'2.2/partials/polygon-draw.html',
            controller:PolygonDrawCtrl
        })
        .when('/2.2/geoobjects/list-objects',{
            templateUrl:'2.2/partials/list-objects.html',
            controller:ListObjectsCtrl
        })
        .when('/2.2/geoobjects/change-parameters',{
            templateUrl:'2.2/partials/change-parameters.html',
            controller:ChangeParametersCtrl
        })
        .when('/2.2/cluster/create',{
            templateUrl:'2.2/partials/create-cluster.html',
            controller:CreateClusterCtrl
        })
        .when('/2.2/cluster/own-icon',{
            templateUrl:'2.2/partials/own-icon.html',
            controller:CreateClusterCtrl
        })
        .when('/2.2/cluster/color',{
            templateUrl:'2.2/partials/cluster-color.html',
            controller:ColorClusterCtrl
        })
        .when('/2.2/cluster/set-size',{
            templateUrl:'2.2/partials/set-size-cluster.html',
            controller:SetSizeClusterCtrl
        })
        .when('/2.2/cluster/two-column',{
            templateUrl:'2.2/partials/cluster-balloon-template-two-column.html',
            controller:ClusterTwoColumnCtrl
        })
        .when('/2.2/cluster/carousel',{
            templateUrl:'2.2/partials/cluster-balloon-template-carousel.html',
            controller:ClusterTwoColumnCtrl
        })
        .when('/2.2/cluster/accordion',{
            templateUrl:'2.2/partials/cluster-balloon-template-accordion.html',
            controller:ClusterAccordionCtrl
        })
        .when('/2.2/cluster/self',{
            templateUrl:'2.2/partials/cluster-balloon-template-self.html',
            controller:ClusterSelfCtrl
        })
        .when('/2.2/geoquery/point-inside-circle',{
            templateUrl:'2.2/partials/point-inside-circle.html',
            controller:PointInsideCircleCtrl
        })
        .when('/2.2/geoquery/find-objects',{
            templateUrl:'2.2/partials/find-objects.html',
            controller:FindObjectsCtrl
        })
        .when('/2.2/geoquery/add-bounds-objects',{
            templateUrl:'2.2/partials/add-bounds-objects.html',
            controller:AddBoundsObjectsCtrl
        })
        .when('/2.2/geoquery/route-mkad',{
            templateUrl:'2.2/partials/route-mkad.html',
            controller:RouteMKADCtrl
        })
        .when('/2.2/geoquery/geocode-result-view',{
            templateUrl:'2.2/partials/geocode-result-view.html',
            controller:GeocodeResultViewCtrl
        })
        .when('/2.2/behaviors/map',{
            templateUrl:'2.2/partials/behaviors.html',
            controller:EmptyCtrl
        })
        .when('/2.2/behaviors/dragger',{
            templateUrl:'2.2/partials/dragger.html',
            controller:DraggerCtrl
        })
        .when('/2.2/geoobjects/events',{
            templateUrl:'2.2/partials/geoobject-events.html',
            controller:GeoObjectEventsCtrl
        })
        .when('/2.2/geoobjects/active-area',{
            templateUrl:'2.2/partials/active-area.html',
            controller:ActiveAreaCtrl
        })
        .when('/2.2/behaviors/coordinate-click',{
            templateUrl:'2.2/partials/click-coordinate.html',
            controller:ClickCoordinateCtrl
        })
        .when('/2.2/geoobjects/change-color',{
            templateUrl:'2.2/partials/change-color.html',
            controller:ChangeColorCtrl
        })
        .when('/2.2/balloon-and-hint/template',{
            templateUrl:'2.2/partials/balloon-template.html',
            controller:BalloonTemplateCtrl
        })
        .when('/2.2/toolbar/standart',{
            templateUrl:'2.2/partials/toolbar-standart.html',
            controller:EmptyCtrl
        })
        .when('/2.2/toolbar/add',{
            templateUrl:'2.2/partials/toolbar-add.html',
            controller:EmptyCtrl
        })
        .when('/2.2/toolbar/add-batton',{
            templateUrl:'2.2/partials/toolbar-batton.html',
            controller:EmptyCtrl
        })
        .when('/2.2/toolbar/button',{
            templateUrl:'2.2/partials/button-template.html',
            controller:EmptyCtrl
        })
        .when('/2.2/toolbar/zoom',{
            templateUrl:'2.2/partials/zoom-template.html',
            controller:ZoomTemplateCtrl
        })
        .when('/2.2/toolbar/list-box',{
            templateUrl:'2.2/partials/list-box-template.html',
            controller:ListBoxTemplateCtrl
        })
        .when('/2.2/geocode/one',{
            templateUrl:'2.2/partials/geocode.html',
            controller:GeocodeCtrl
        })
        .when('/2.2/geocode/multi',{
            templateUrl:'2.2/partials/multi-geocode.html',
            controller:MultiGeocodeCtrl
        })
        .when('/2.2/traffic/element',{
            templateUrl:'2.2/partials/traffic.html',
            controller:EmptyCtrl
        })
        .when('/2.2/traffic/without-button',{
            templateUrl:'2.2/partials/traffic-without-button.html',
            controller:TrafficWithoutButtonCtrl
        })
        .when('/2.2/geolocation/api',{
            templateUrl:'2.2/partials/geolocation-api.html',
            controller:GeolocationApiCtrl
        })
        .when('/2.2/geolocation/place',{
            templateUrl:'2.2/partials/geolocation-place.html',
            controller:EmptyCtrl
        })
        .when('/2.2/route/create',{
            templateUrl:'2.2/partials/route.html',
            controller:RouteCtrl
        })
        .when('/2.2/route/edit',{
            templateUrl:'2.2/partials/route-edit.html',
            controller:RouteEditCtrl
        })
        .when('/2.2/route/calculate-cost',{
            templateUrl:'2.2/partials/calculate-cost.html',
            controller:CalculateCostCtrl
        })
        .when('/2.2/performance/test',{
            templateUrl:'2.2/partials/performance-test.html',
...
directive('activeClass',function(){
    ...
    controller('MainCtrl',['$scope', '$route', '$routeParams', '$location',MainCtrl]);
